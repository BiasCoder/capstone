...
- [ ] [Create](https://docs.gitlab.com/ee/userEntity/project/repository/web_editor.html#create-a-file)
  or [upload](https://docs.gitlab.com/ee/userEntity/project/repository/web_editor.html#upload-a-file) files
...
```
cd existing_repo
git remote add origin http://gitlab.doku.com/da-team/da-batch-3-ii/da3-dua-web-service-api.git
git branch -M main
...
- [ ] [Set up project integrations](http://gitlab.doku.com/da-team/da-batch-3-ii/da3-dua-web-service-api/-/settings/integrations)
